...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    const newErrors = {};
    if (!formData.username) newErrors.username = "Please enter your full name.";
    ...
    <div className='relative w-[330px] lg:w-[450px] h-auto p-8 mx-auto my-[40px] shadow-lg bg-white rounded'>
      {showSuccessCard && (
        <div className="absolute inset-0 bg-white/90 backdrop-blur-sm flex flex-col items-center justify-center p-6 shadow-md rounded z-10">
          ...
          <button
            ...
            className="mt-4 bg-[#d93e00] text-white px-4 py-2 rounded hover:bg-[#c03200]"
          >
            Close
          </button>
        </div>
      ...
      <form onSubmit={handleSignup} className='flex flex-col'>
        ...
        <input
          ...
          className='w-[270px] lg:w-[380px] border border-gray-300 p-1 rounded-[4px] mb-1 shadow-2xs'
        />
        ...
        <div className='flex w-[270px] lg:w-[380px] rounded-[4px] mb-1 shadow-2xs items-center pr-1 justify-between border border-gray-300'>
          <input
